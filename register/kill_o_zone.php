...
<?php
  ...
  {
  $userid=$rows['userid'];
   @$query="select userid1 from kill_o_zone where userid1='$userid'";
...
?>
<br/><br>
<h1 style="margin-left:180px;">Kill-O-Zone Registration Form</h1>
  ...
  <table>
    <tr><td><span style="margin-left:220px;">Event Name:&nbsp;&nbsp;</span><select id="eventname" name="eventname" />
                                      <option value="kill_o_zone">Kill-O-Zone</option>
