...
<?php
  ...
  {
  $userid=$rows['userid'];
   @$query="select userid1 from photomontage where userid1='$userid'";
...
<span style="text-align:center;"> The registration for photomontage has been closed. For more details contact respective coordinators. </span>
<!--<h1 style="margin-left:180px;">Photomontage Registration Form</h1>
