...
<?php
  ...
  {
  $userid=$rows['userid'];
   @$query="select userid1 from technicoskartun where userid1='$userid'";
...
?>
<br/><br>
<h1 style="margin-left:180px;">Technicos Kartun Registration Form</h1>


  <!--  The form that will be parsed by jQuery before submit  -->
  <div>
  <form action="eventsubmit1.php" method="post" id="register-form" >
  <table>
    <tr><td><span style="margin-left:220px;">Event Name:&nbsp;&nbsp;</span><select id="eventname" name="eventname" />
                                      <option value="technicoskartun">Technicos Kartun</option>
