...
<?php
  ...
  {
  $userid=$rows['userid'];
   @$query="select userid1 from line_apostle where userid1='$userid'";
...
?>
<br/><br>
<h1 style="margin-left:180px;">Line Apostle Registration Form</h1>
  ...
  <table>
    <tr><td><span style="margin-left:220px;">Event Name:&nbsp;&nbsp;</span><select id="eventname" name="eventname" />
                                      <option value="line_apostle">Line Apostle</option>
  ...
  <tr>
   <td><span style="color:red;margin-left:72px;">
   <?php $reasons = array("wronguserid3" => "User3 is not registered user. Please register first.", "blank" => "You have left one or more fields blank."); if ($_GET["regifailed"]) echo $reasons[$_GET["reason"]]; ?>
  </span> </td></tr>
   </tr>
  ...
  <tr>
   ...
   <tr>
   <td><span style="color:red;margin-left:72px;">
   <?php $reasons = array("wronguserid4" => "User4 is not registered user. Please register first.", "blank" => "You have left one or more fields blank."); if ($_GET["regifailed"]) echo $reasons[$_GET["reason"]]; ?>
  </span> </td>
   </tr>
  </table> 
