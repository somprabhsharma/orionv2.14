...
<?php
  ...
  {
  $userid=$rows['userid'];
   @$query="select userid1 from needforspeed where userid1='$userid'";
...
?>
<br/><br>
<h1 style="margin-left:180px;">Need for Speed Registration Form</h1>
  ...
  <table>
    <tr><td><span style="margin-left:220px;">Event Name:&nbsp;&nbsp;</span><select id="eventname" name="eventname" />
                                      <option value="needforspeed">Need for Speed</option>
